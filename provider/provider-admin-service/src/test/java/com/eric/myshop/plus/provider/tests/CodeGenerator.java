...
public class CodeGenerator {
  ...
  public static void main(String[] args) {
    ...
    gc.setOutputDir(
        "/Users/ericshen/Code/personal/MyShopPlus/provider/provider-admin-service"
            + "/src/main/java");
    ...
    dsc.setUrl(
        "jdbc:mysql://127.0.0.1:3306/mplus_ums_admin?useUnicode=true&characterEncoding=utf-8&useSSL=false");
    ...
    pc.setParent("com.eric.myshop.plus.provider");
